...
for ($i = 0;$i < $quantidade;$i++) {
    if ($varchar_key[$i] || $select_key[$i] || $quantidade < 2 || ($type_tabela && $GLOBALS[$type_tabela_key][$i])) {
        ...
        // Select_Multi
        if (!isset($interadmin_select_multi_1) && isset($interadmin_select_multi_1_xtra)) {
            $interadmin_select_multi_1 = '';
        }
        if (!isset($interadmin_select_multi_2) && isset($interadmin_select_multi_2_xtra)) {
            $interadmin_select_multi_2 = '';
        }
