 ...
 * @param string $var
 * @return string
 * @deprecated Essa funÁ„o faz a mesma coisa que trim(), n„o deveria ter sido criada.
 */
...
function curl_get_contents($url, $options = array()) {
	...
	if (ini_get('open_basedir') != '') {
		throw new Exception('CURL n„o segue redirects com open_basedir ligado. Desligue o open_basedir.');
	}
