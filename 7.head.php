...
<?php } ?>
<html xmlns="http://www.w3.org/1999/xhtml"<?php echo $config->html_facebook_namespace ? ' xmlns:fb="http://www.facebook.com/2008/fbml"' : ''; ?>>
<head>
...
<meta name="author" content="JP7 - http://jp7.com.br<? if($c_parceiro) { ?> | <?php echo $c_parceiro; ?><? } ?>" />
